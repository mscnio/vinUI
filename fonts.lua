...
fonts:SetScript("OnEvent", function()
	local NORMAL     = "FONTS\\FRIZQT__.ttf"
	local BOLD       = "FONTS\\FRIZQT__.ttf"
	local BOLDITALIC = "FONTS\\FRIZQT__.ttf"
	local ITALIC     = "FONTS\\FRIZQT__.ttf"
	local NUMBER     = "FONTS\\FRIZQT__.ttf"

	UIDROPDOWNMENU_DEFAULT_TEXT_HEIGHT = 12
	CHAT_FONT_HEIGHTS = {12, 13, 14, 15, 16, 17, 18}
	...
	SetFont(GameNormalNumberFont,                 BOLD, 11, "OUTLINE")
	...
	for i=1,7 do
		...
		f:SetFont("FONTS\\ARIALN.ttf", 15, "OUTLINE")
	end
